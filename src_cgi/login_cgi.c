...
#include "md5.h"    //md5
#include <time.h>
//  gcc -o login_cgi login_cgi.c ../common/redis_op.c ../common/des.c ../common/base64.c ../common/md5.c ../common/make_log.c ../common/util_cgi.c ../common/deal_mysql.c ../common/cfg.c ../common/cJSON.c -lmysqlclient -lm -lfcgiak -lhiredis
